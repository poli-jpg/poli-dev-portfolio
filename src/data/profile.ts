// Single source of truth for identity and contact info.
// Update the placeholders below with real values before deploying.
export const profile = {
  ...
  contact: {
    ...
    github: "https://github.com/poli-jpg",
    linkedin: "", // Placeholder — add your LinkedIn URL here.
    instagram: "", // Placeholder — optional, add your Instagram URL here.
  },
  seo: {
    title: "Poli Dev — Software Developer",
    description:
      "Portfolio de Poli Dev — développeur passionné par le développement web, les applications logicielles et les solutions numériques.",
